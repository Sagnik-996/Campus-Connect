...
async function initEventDetailsPage() {
  ...
  if (bookingForm) {
    bookingForm.addEventListener('submit', async (e) => {
      e.preventDefault();
      const seatsInput = document.getElementById('booking-seats');
      const seatsBooked = parseInt(seatsInput.value, 10);
...
async function initEventEditorPage() {
  ...
  form.addEventListener('submit', async (e) => {
    ...
    const dept_id = parseInt(document.getElementById('edit-event-dept').value, 10);
    const venue_id = parseInt(document.getElementById('edit-event-venue').value, 10);
    const total_seats = parseInt(document.getElementById('edit-event-seats').value, 10);
...
async function initManageVenuesPage() {
  ...
  form.addEventListener('submit', async (e) => {
    ...
    const capacity = parseInt(document.getElementById('venue-capacity').value, 10);
